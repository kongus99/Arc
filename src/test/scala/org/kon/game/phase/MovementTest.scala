...
class MovementTest extends FunSpec {
  describe("A simple adjacent move") {
    ...
    val move: Movement = new Movement(1, 3 :: Nil)
  ...
  describe("A back and forth move") {
    val move: Movement = new Movement(1, 3 :: 1 :: Nil)
  ...
  describe("A two field move") {
    val move: Movement = new Movement(1, 3 :: 2 :: Nil)
  ...
  describe("A three field move") {
    val move: Movement = new Movement(1, 3 :: 2 :: 4 :: Nil)
  ...
  describe("A three field loop move") {
    val move: Movement = new Movement(1, 3 :: 2 :: 1 :: Nil)
